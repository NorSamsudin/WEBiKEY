<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ImportSpeciesAndStates.aspx.cs" Inherits="WEBiKEY.Application.Admin.ImportSpeciesAndStates" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContent" runat="server">
    <asp:Wizard ID="ExcelImportWizard" runat="server" ActiveStepIndex="0" BackColor="#E6E2D8" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CancelDestinationPageUrl="~/Default.aspx"
        DisplayCancelButton="True" Font-Names="Verdana" Font-Size="Small" HeaderText="Import Species and States" Height="300px" OnActiveStepChanged="ExcelImportWizard_ActiveStepChanged"
        ...
        <NavigationButtonStyle BackColor="White" BorderColor="#C5BBAF" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="Medium" ForeColor="#1C5E55" />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RadioButtonList ID="RadioButtonListOptions" runat="server" CellSpacing="0" RepeatLayout="Flow">
                                ...
                                <asp:ListItem Selected="True" Value="Overwrite">Overwrite Existing Data <strong style="color: red;">(This will delete all existing species info including images and description files)</strong>
                                </asp:ListItem>
                            </asp:RadioButtonList>
            ...
            <asp:WizardStep ID="WizardStep2" runat="server" Title="Configure Columns">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="dgvColumns" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Database Column">
                                    <ItemTemplate>
                                        <asp:DropDownList OnSelectedIndexChanged="ItemDropDown_SelectedIndexChanged" DataSource='<%# this.items %>' DataTextField="Value" DataValueField="Key" ID="ItemDropDown" runat="server"
                                            AutoPostBack="true" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        ...
                        <asp:Label ID="lblNoError" runat="server" Font-Bold="True" Font-Size="X-Small" ForeColor="Green"></asp:Label>
                        <asp:CustomValidator ID="CustomValidatorValidateMapping" runat="server" ErrorMessage="Error!" OnServerValidate="CustomValidatorValidateMapping_ServerValidate" Font-Bold="True" Font-Size="X-Small"
